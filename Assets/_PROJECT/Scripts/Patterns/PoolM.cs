...
public static class PoolExtension
{
    ...
    public static object GetPoolPreSpawned(object[] pool, ref int poolID) 
    {
    ...
    public static void AddPool(UnityEngine.Object _objectToAdd, int _limit, string id) 
    {
        ...
        if (PoolM.Instance.poolDict.ContainsKey(id)) return;
        ...
        for(int i = 0; i < _limit ; i++)
        {
            ...
            //GameObject _newItemG = (GameObject)GetPoolDict(id);
            // _newItemG.SetActive(_activate);
